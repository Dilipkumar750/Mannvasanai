...
import pongar from "../assets/pongar.png";
import mappilai from "../assets/mappilai samba.png";
import seragasamba from "../assets/seraga samba 1.png";
import navarasa from "../assets/navarasa.jpg";
import karuppukavuni from "../assets/karuppu kavuni.png";
import brown from "../assets/brown.jpg";

const riceVarieties = [
    { name: 'கருப்புகவுணி அரிசி', benefits: 'புற்று நோய் வராது, இன்சுலின் சுரக்கும்' },
    ...
    { name: 'இலுப்பை சம்பா அரிசி', benefits: 'பக்கவாதம், கால் வலி சரியாகும்' },
    ...
    { name: 'கிச்சி சம்பா அரிசி', benefits: 'இரும்பு சத்து, சுண்ணாம்பு சத்து அதிகம்' },
    { name: 'நீலம் சம்பா அரிசி', benefits: 'இரத்த சோகை நீங்கும்' },
    { name: 'சீரக சம்பா அரிசி', benefits: 'அழகு தரும், எதிர்ப்பு சக்தி கூடும்' },
    { name: 'தூயமல் அரிசி', benefits: 'உள் உறுப்புகள் வலுவாகும்' },
