...
import menu1 from '../assets/image7.png';
import menu2 from '../assets/ell-urundai1.png';
import menu3 from '../assets/image4.png';
import menu4 from '../assets/image5.png';
import menu5 from '../assets/mixture.png';
import menu6 from '../assets/snacks3.png';
import menu7 from '../assets/image3.png';
import menu8 from '../assets/burfi.png';
...
function Menu() {
    ...
    const menuData = [
        ...
        { id: 6, heading: "சிறுதானிய / பாரம்பரிய அரிசி மிக்சர்", price: "$10", subtitle: "சிறுதானியங்கள்", img: menu5, category: "Snacks", detail: "இந்த சிறுதானிய மிக்சர் பாரம்பரிய முறைப்படி குதிரைவாலி, தினை, சாமை போன்ற சிறுதானியங்களால் தயாரிக்கப்பட்டது. இதில் உள்ள ஒவ்வொரு தானியமும் உடலுக்கு சத்துக்களை வழங்குவதோடு, இந்த மிக்சர் நார்ச்சத்து, கனிமச்சத்து ஆகியவற்றில் வளமையாகவும் உள்ளது. நேர்த்தியான காய்கலை முறை மற்றும் கிராமிய சுவையோடு இந்த மிக்சர் குடும்பம் முழுவதற்கும் ஆரோக்கியமான இடைவேளி சிற்றுண்டியாக பயன்படும்." },
        {
            id: 7, heading: "பாரம்பரிய அரிசி ரிப்பன் முறுக்கு", price: "$10", subtitle: "தேங்காய் பால்", img: menu6, category: "Snacks", detail: "இந்த சிறுதானிய ரிப்பன் பக்கோடா, சுவையான தேங்காய் சேர்க்கப்பட்டு பாரம்பரிய முறையில் தயாரிக்கப்பட்டது.குதிரைவாலி, தினை, சாமை போன்ற சிறுதானியங்களின் தனிச்சுவையுடன் தேங்காயின் இனிய மணமும் சேர்ந்து, இந்த பக்கோடாவை சுவையான மற்றும் சத்தான இடைவேளி சிற்றுண்டியாக ஆக்குகிறது.இது உங்கள் உடலுக்கு ஆரோக்கியம் தரும் சுவையான நொறுக்குத்தீனியாகும்."
        },
